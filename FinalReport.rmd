...
I will use the Cat~Cat helper file, since both variables are categorical 
...
This plot shows that there may be a difference between belief in the BIGBANG based on RACE; blacks tend not to belive in BIGBANG, white and other are about even.
...
The table indicates black is about 80-20 in not believing in the BIGBANG. White and other are about 50-50
...
1. The Chi-squared test showed that the numbers for Blacks in false were highter than the rest.

2. The 2x2 fisher tests showed the differences in belief in the big bang theory by race in blacks having a higher rate of false than white and other. 
